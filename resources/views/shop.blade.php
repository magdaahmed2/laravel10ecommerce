                            ...
                            <div id="collapseSix" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                       ...
                                       <li>
                                        <div class="form-check ps-0 custome-form-check">
                                            <input class="checkbox_animated check-it" id="ct1{{ $cat->id}}" name="categories"
                                            @if(in_array($cat->id,explode(',',$q_categories))) checked="checked" @endif
                                            value="{{$cat->id}}" type="checkbox" onchange="filterProductsByCategory(this)">
                                            <label class="form-check-label">{{ $cat->name }}</label>
                                            <p class="font-light">({{ $cat->products->count()}})</p>
                                        </div>
                                    </li>
                                       @endforeach
                            ...
                            <div class="select-options">
                                ...
                                <div class="dropdown select-featured">
                                    <select class="form-select" name="size" id="pagesize">
                                        <option value="2" {{ $size == 2? 'selected':'' }}>2 Products Per Page</option>
                                        <option value="4" {{ $size == 4 ?'selected':'' }}>4 Products Per Page</option>
                                        <option value="8" {{ $size == 8 ?'selected':'' }}>8 Products Per Page</option>
                                        <option value="10" {{ $size == 10 ?'selected':'' }}>10 Products Per Page</option>
                                    </select>
                                </div>
                            </div>
                  ...
                  <div>
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="{{route('shop.product.details',['slug'=>$pro->slug])}}">
                                    <img src="assets/images/fashion/product/front/{{$pro->image}}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                            <div class="back">
                                <a href="{{route('shop.product.details',['slug'=>$pro->slug])}}">
                                    <img src="assets/images/fashion/product/back/{{$pro->image}}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                            <div class="cart-wrap">
                        ...
                        <div class="product-details">
                            <div class="rating-details">
                                <span class="font-light grid-content">{{$pro->category->name}}</span>
                            ...
                            <div class="main-price">
                                <a href="{{route('shop.product.details',['slug'=>$pro->slug])}}" class="font-default">
                                    <h5 class="ms-0">{{$pro->name}}</h5>
                                </a>
                                <div class="listing-content">
                                    <span class="font-light">{{$pro->category->name}}</span>
                                    <p class="font-light">{{$pro->short_description}}</p>
                                </div>
                                <h3 class="theme-color">${{$pro->regular_price}}</h3>
